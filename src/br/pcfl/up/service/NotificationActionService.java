...
public class NotificationActionService extends CoreService {
    ...
    public int startService(Intent intent, int startId) {
        if (Up.DEBUG)
            Log.i(Up.LOG_TAG, "NotificationActionService started with startId = " + startId);
        ...
        if (account != null) {
            if (READ_ALL_ACTION.equals(action)) {
                if (Up.DEBUG)
                    Log.i(Up.LOG_TAG, "NotificationActionService marking messages as read");
                ...
                if (Up.DEBUG)
                    Log.i(Up.LOG_TAG, "NotificationActionService deleting messages");
                ...
                if (Up.DEBUG)
                    Log.i(Up.LOG_TAG, "NotificationActionService initiating reply");
                ...
                if (message != null) {
                    ...
                    Log.i(Up.LOG_TAG, "Could not execute reply action.");
                }
            ...
            Log.w(Up.LOG_TAG, "Could not find account for notification action.");
        }
