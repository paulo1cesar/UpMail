...
public class DatabaseUpgradeService extends Service {
    ...
    public final int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (success) {
            ...
            if (Up.DEBUG) {
                Log.i(Up.LOG_TAG, "DatabaseUpgradeService started");
            }
    ...
    private void stopService() {
        ...
        if (Up.DEBUG) {
            Log.i(Up.LOG_TAG, "DatabaseUpgradeService stopped");
        }
    ...
    private void upgradeDatabases() {
        ...
        for (Account account : accounts) {
            ...
            try {
                ...
                Log.e(Up.LOG_TAG, "Database unavailable");
            } catch (Exception e) {
                Log.e(Up.LOG_TAG, "Error while upgrading database", e);
            }

            mProgress++;
        }

        Up.setDatabasesUpToDate(true);
