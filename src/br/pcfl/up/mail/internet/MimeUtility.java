...
package br.pcfl.up.mail.internet;
...
import br.pcfl.up.mail.internet.BinaryTempFileBody.BinaryTempFileBodyInputStream;
...
public class MimeUtility {
    ...
    public static final String Up_SETTINGS_MIME_TYPE = "application/x-Upsettings";
    ...
    public static String getTextFromPart(Part part) {
        try {
             ...
             */
            Log.e(Up.LOG_TAG, "Unable to getTextFromPart " + oom.toString());
        } catch (Exception e) {
            /*
             * If we are not able to process the body there's nothing we can do about it. Return
             * null and let the upper layers handle the missing content.
             */
            Log.e(Up.LOG_TAG, "Unable to getTextFromPart", e);
        }
        return null;
    }
    ...
    public static String readToString(InputStream in, String charset) throws IOException {
        ...
        for (String[] rule: CHARSET_FALLBACK_MAP) {
            ...
            if (charset.matches(rule[0])) {
                Log.e(Up.LOG_TAG, "I don't know how to deal with the charset " + charset +
