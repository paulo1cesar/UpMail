        ...
        try {
            ...
            for (int i = 0, count = parsedList.size(); i < count; i++) {
                ...
                if (address instanceof Mailbox) {
                    ...
                    Log.e(Up.LOG_TAG, "Unknown address type from Mime4J: "
                            + address.getClass().toString());
                }
            }
        } catch (MimeException pe) {
            Log.e(Up.LOG_TAG, "MimeException in Address.parse()", pe);
        ...
        if (!Up.showCorrespondentNames()) {
            ...
            if (name != null) {
                if (Up.changeContactNameColor()) {
                    ...
                    coloredName.setSpan(new ForegroundColorSpan(Up.getContactNameColor()),
                                        0,
                                        coloredName.length(),
