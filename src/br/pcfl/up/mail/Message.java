...
import br.pcfl.up.mail.filter.CountingOutputStream;
...
public abstract class Message implements Part, CompositeBody {
    ...
    public long calculateSize() {
        try {
            ...
            Log.e(Up.LOG_TAG, "Failed to calculate a message size", e);
     ...
     * {@link com.fsck.k9.activity.MessageView.Listener#loadMessageForViewHeadersAvailable(br.pcfl.up.Account, String, String, Message)}
