...
public class Contacts {
     ...
     * {@link br.pcfl.up.EmailAddressAdapter} or more specificly by
    ...
    public ContactItem extractInfoFromContactPickerIntent(final Intent intent) {
        ...
        try {
            ...
            Log.e(Up.LOG_TAG, "Failed to get email data", e);
        } finally {
    ...
    public Uri getPhotoUri(String address) {
        ...
        try {
            ...
            Log.e(Up.LOG_TAG, "Couldn't fetch photo for contact with email " + address, e);
            return null;
        }
    }
