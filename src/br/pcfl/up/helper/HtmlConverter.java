...
public class HtmlConverter {
     ...
     * {@link br.pcfl.up.view#MessageWebView.setText(String) MessageWebView.setText()}
     * </p>
     *
     * @param text
     *         Plain text string.
    ...
    private static String simpleTextToHtml(String text) {
        ...
        try {
            ...
            //Should never happen
            Log.e(Up.LOG_TAG, "Could not read string to convert text to HTML:", e);
        }
    ...
    public static String cssStylePre() {
        final String font = Up.messageViewFixedWidthFont()
                ? "monospace"
                : "sans-serif";
