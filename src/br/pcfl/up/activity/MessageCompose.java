...
import br.pcfl.up.EmailAddressAdapter;
import br.pcfl.up.EmailAddressValidator;
import br.pcfl.up.FontSizes;
import br.pcfl.up.Identity;
import br.pcfl.up.Preferences;
import br.pcfl.up.R;
import br.pcfl.up.Up;
import br.pcfl.up.Account.MessageFormat;
import br.pcfl.up.Account.QuoteStyle;
import br.pcfl.up.activity.loader.AttachmentContentLoader;
import br.pcfl.up.activity.loader.AttachmentInfoLoader;
import br.pcfl.up.activity.misc.Attachment;
import br.pcfl.up.controller.MessagingController;
import br.pcfl.up.controller.MessagingListener;
import br.pcfl.up.crypto.CryptoProvider;
import br.pcfl.up.crypto.PgpData;
import br.pcfl.up.fragment.ProgressDialogFragment;
import br.pcfl.up.helper.ContactItem;
...
import br.pcfl.up.mail.Multipart;
...
import br.pcfl.up.mail.store.LocalStore.LocalAttachmentBody;
import br.pcfl.up.mail.store.LocalStore.TempFileBody;
import br.pcfl.up.mail.store.LocalStore.TempFileMessageBody;
...
public class MessageCompose extends UpActivity implements OnClickListener,
    ...
    private static final String ACTION_COMPOSE = "br.pcfl.up.intent.action.COMPOSE";
    private static final String ACTION_REPLY = "br.pcfl.up.intent.action.REPLY";
    private static final String ACTION_REPLY_ALL = "br.pcfl.up.intent.action.REPLY_ALL";
    private static final String ACTION_FORWARD = "br.pcfl.up.intent.action.FORWARD";
    private static final String ACTION_EDIT_DRAFT = "br.pcfl.up.intent.action.EDIT_DRAFT";
    ...
    private static final String STATE_KEY_ATTACHMENTS =
        "br.pcfl.up.activity.MessageCompose.attachments";
    private static final String STATE_KEY_CC_SHOWN =
        "br.pcfl.up.activity.MessageCompose.ccShown";
    private static final String STATE_KEY_BCC_SHOWN =
        "br.pcfl.up.activity.MessageCompose.bccShown";
    private static final String STATE_KEY_QUOTED_TEXT_MODE =
        "br.pcfl.up.activity.MessageCompose.QuotedTextShown";
    private static final String STATE_KEY_SOURCE_MESSAGE_PROCED =
        "br.pcfl.up.activity.MessageCompose.stateKeySourceMessageProced";
    private static final String STATE_KEY_DRAFT_ID = "br.pcfl.up.activity.MessageCompose.draftId";
    private static final String STATE_KEY_HTML_QUOTE = "br.pcfl.up.activity.MessageCompose.HTMLQuote";
    private static final String STATE_IDENTITY_CHANGED =
        "br.pcfl.up.activity.MessageCompose.identityChanged";
    private static final String STATE_IDENTITY =
        "br.pcfl.up.activity.MessageCompose.identity";
    private static final String STATE_PGP_DATA = "pgpData";
    private static final String STATE_IN_REPLY_TO = "br.pcfl.up.activity.MessageCompose.inReplyTo";
    private static final String STATE_REFERENCES = "br.pcfl.up.activity.MessageCompose.references";
    private static final String STATE_KEY_READ_RECEIPT = "br.pcfl.up.activity.MessageCompose.messageReadReceipt";
    private static final String STATE_KEY_DRAFT_NEEDS_SAVING = "br.pcfl.up.activity.MessageCompose.mDraftNeedsSaving";
    private static final String STATE_KEY_FORCE_PLAIN_TEXT =
            "br.pcfl.up.activity.MessageCompose.forcePlainText";
    private static final String STATE_KEY_QUOTED_TEXT_FORMAT =
            "br.pcfl.up.activity.MessageCompose.quotedTextFormat";
    ...
    private FontSizes mFontSizes = Up.getFontSizes();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Up.DEBUG && mSourceMessageBody != null)
            Log.d(Up.LOG_TAG, "Composing message with explicitly specified message body.");
        ...
        if (initFromIntent(intent)) {
            ...
            if (ACTION_COMPOSE.equals(action)) {
                ...
                Log.w(Up.LOG_TAG, "MessageCompose was started with an unsupported action");
                mAction = Action.COMPOSE;
            }
        }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.w(Up.LOG_TAG, "Couldn't read value \" + STATE_KEY_WAITING_FOR_ATTACHMENTS +" +
    ...
    private TextBody buildText(boolean isDraft, SimpleMessageFormat messageFormat) {
        ...
        if (messageFormat == SimpleMessageFormat.HTML) {
            ...
            if (includeQuotedText && mQuotedHtmlContent != null) {
                if (Up.DEBUG) {
                    Log.d(Up.LOG_TAG, "insertable: " + mQuotedHtmlContent.toDebugString());
                }
    ...
    private MimeMessage createMessage(boolean isDraft) throws MessagingException {
        ...
        if (isDraft) {
            ...
            message.addHeader(Up.IDENTITY_HEADER, buildIdentityHeader(body, bodyPlain));
        }
    ...
    private String buildIdentityHeader(final TextBody body, final TextBody bodyPlain) {
        ...
        if (Up.DEBUG) {
            Log.d(Up.LOG_TAG, "Generated identity: " + k9identity);
        }
    ...
    private Map<IdentityField, String> parseIdentityHeader(final String identityString) {
        ...
        if (Up.DEBUG)
            Log.d(Up.LOG_TAG, "Decoding identity: " + identityString);
        ...
        if (identityString.charAt(0) == IDENTITY_VERSION_1.charAt(0) && identityString.length() > 2) {
            ...
            if (Up.DEBUG)
                Log.d(Up.LOG_TAG, "Decoded identity: " + identity.toString());
            ...
            for (IdentityField key : IdentityField.getIntegerFields()) {
                if (identity.get(key) != null) {
                    try {
                        ...
                        Log.e(Up.LOG_TAG, "Invalid " + key.name() + " field in identity: " + identity.get(key));
                    }
                }
            }
        } else {
            ...
            if (Up.DEBUG)
                Log.d(Up.LOG_TAG, "Got a saved legacy identity: " + identityString);
            ...
            if (tokenizer.hasMoreTokens()) {
                ...
                try {
                    ...
                    Log.e(Up.LOG_TAG, "Unable to parse bodyLength '" + bodyLengthS + "'");
                }
            }
            if (tokenizer.hasMoreTokens()) {
    ...
    private void performSend() {
        ...
        if (mMessageReference != null && mMessageReference.flag != null) {
            if (Up.DEBUG)
                Log.d(Up.LOG_TAG, "Setting referenced message (" + mMessageReference.folderName + ", " + mMessageReference.uid + ") flag to " + mMessageReference.flag);
    ...
    private void onAddAttachment() {
        if (Up.isGalleryBuggy()) {
            if (Up.useGalleryBugWorkaround()) {
        ...
        case CONTACT_PICKER_BCC:
            ...
            if (Up.DEBUG) {
                ...
                for (int i = 0; i < emails.size(); i++) {
                    Log.v(Up.LOG_TAG, "email[" + i + "]: " + emails.get(i));
                }
            }
    ...
    private void onAccountChosen(Account account, Identity identity) {
        if (!mAccount.equals(account)) {
            if (Up.DEBUG) {
                Log.v(Up.LOG_TAG, "Switching account from " + mAccount + " to " + account);
            }
            ...
            if (mDraftNeedsSaving || (mDraftId != INVALID_DRAFT_ID)) {
                ...
                if (Up.DEBUG) {
                    Log.v(Up.LOG_TAG, "Account switch, saving new draft in new account");
                }
                saveMessage();

                if (previousDraftId != INVALID_DRAFT_ID) {
                    if (Up.DEBUG) {
                        Log.v(Up.LOG_TAG, "Account switch, deleting draft from previous account: "
                              + previousDraftId);
                    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
         ...
         */
        menu.findItem(R.id.add_attachment_image).setVisible(Up.useGalleryBugWorkaround());
        menu.findItem(R.id.add_attachment_video).setVisible(Up.useGalleryBugWorkaround());
    ...
    private void processSourceMessage(Message message) {
        try {
            switch (mAction) {
                ...
                default: {
                    Log.w(Up.LOG_TAG, "processSourceMessage() called with unsupported action");
                    break;
                }
            }
             ...
             */
            Log.e(Up.LOG_TAG, "Error while processing source message: ", me);
        } finally {
    ...
    private void processMessageToReplyTo(Message message) throws MessagingException {
        ...
        if (message.getMessageId() != null && message.getMessageId().length() > 0) {
            ...
            if (Up.DEBUG)
                Log.d(Up.LOG_TAG, "could not get Message-ID.");
        }
    ...
    private void processDraftMessage(Message message) throws MessagingException {
        ...
        if (message.getHeader(Up.IDENTITY_HEADER) != null && message.getHeader(Up.IDENTITY_HEADER).length > 0 && message.getHeader(Up.IDENTITY_HEADER)[0] != null) {
            k9identity = parseIdentityHeader(message.getHeader(Up.IDENTITY_HEADER)[0]);
        }
        ...
        if (k9identity.containsKey(IdentityField.ORIGINAL_MESSAGE)) {
            ...
            try {
                ...
                Log.e(Up.LOG_TAG, "Could not decode message reference in identity.", e);
            }
        }
        ...
        if (k9identity.containsKey(IdentityField.CURSOR_POSITION)) {
            try {
                ...
                Log.e(Up.LOG_TAG, "Could not parse cursor position for MessageCompose; continuing.", e);
            }
        }
        ...
        if (messageFormat == MessageFormat.HTML) {
            ...
            if (part != null) { // Shouldn't happen if we were the one who saved it.
                ...
                if (Up.DEBUG) {
                    Log.d(Up.LOG_TAG, "Loading message with offset " + bodyOffset + ", length " + bodyLength + ". Text length is " + text.length() + ".");
                }

                if (bodyOffset + bodyLength > text.length()) {
                    // The draft was edited outside of K-9 Mail?
                    Log.d(Up.LOG_TAG, "The identity field from the draft contains an invalid LENGTH/OFFSET");
                    bodyOffset = 0;
                    bodyLength = 0;
                }
                // Grab our reply text.
            ...
            Log.e(Up.LOG_TAG, "Unhandled message format.");
        }
        ...
        try {
            ...
            Log.e(Up.LOG_TAG, "Could not set cursor position in MessageCompose; ignoring.", e);
        }
        ...
        if (textPart != null) {
            ...
            if (bodyLength > 0) {
                try {
                    ...
                    Log.d(Up.LOG_TAG, "The identity field from the draft contains an invalid bodyOffset/bodyLength");
                    if (viewMessageContent) {
                        mMessageContentView.setCharacters(text);
                    }
                }
            ...
            if (mAccount.isStripSignature() &&
                ...
                if (dashSignatureHtml.find()) {
                    ...
                    if (start.size() != end.size()) {
                        Log.d(Up.LOG_TAG, "There are " + start.size() + " <blockquote> tags, but " +
                ...
                try {
                    ...
                    Log.e(Up.LOG_TAG, "Problem cleaning quoted message.", ioe);
                }
            }
    ...
    private String getBodyTextFromMessage(final Message message, final SimpleMessageFormat format)
        ...
        if (format == SimpleMessageFormat.HTML) {
            ...
            if (part != null) {
                if (Up.DEBUG)
                    Log.d(Up.LOG_TAG, "getBodyTextFromMessage: HTML requested, HTML found.");
            ...
            if (part != null) {
                if (Up.DEBUG)
                    Log.d(Up.LOG_TAG, "getBodyTextFromMessage: HTML requested, text found.");
            ...
            if (part != null) {
                if (Up.DEBUG)
                    Log.d(Up.LOG_TAG, "getBodyTextFromMessage: Text requested, text found.");
                return MimeUtility.getTextFromPart(part);
            }
            ...
            if (part != null) {
                if (Up.DEBUG)
                    Log.d(Up.LOG_TAG, "getBodyTextFromMessage: Text requested, HTML found.");
    ...
    private InsertableHtmlContent findInsertionPoints(final String content) {
        ...
        if (Up.DEBUG)
            Log.d(Up.LOG_TAG, "Open: hasHtmlTag:" + hasHtmlTag + " hasHeadTag:" + hasHeadTag + " hasBodyTag:" + hasBodyTag);
        ...
        if (Up.DEBUG)
            Log.d(Up.LOG_TAG, "Close: hasHtmlEndTag:" + hasHtmlEndTag + " hasBodyEndTag:" + hasBodyEndTag);
                ...
                public void run() {
                    ...
                    if (mSourceProcessed) {
                        try {
                            ...
                            showOrHideQuotedText(QuotedTextMode.HIDE);
                            Log.e(Up.LOG_TAG, "Could not re-process source message; deleting quoted text to be safe.", e);
                        }
                        updateMessageFormat();
                    } else {
    ...
    private class SendMessageTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                Log.e(Up.LOG_TAG, "Failed to create new message for send or save.", me);
            ...
            try {
                ...
                Log.e(Up.LOG_TAG, "Failed to mark contact as contacted.", e);
            }
