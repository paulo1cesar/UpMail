...
import br.pcfl.up.service.DatabaseUpgradeService;
 ...
 *     method.</li>
 * <li>{@link #actionUpgradeDatabases(Context, Intent)} will call {@link Up#areDatabasesUpToDate()}
 *     to check if we already know whether the databases have been upgraded.</li>
 * <li>{@link Up#areDatabasesUpToDate()} will compare the last known database version stored in a
 *     {@link SharedPreferences} file to {@link br.pcfl.up.mail.store.LocalStore#DB_VERSION}. This
 ...
 * </p>
 */
public class UpgradeDatabases extends UpActivity {
