...
public class ChooseIdentity extends UpListActivity {
    Account mAccount;
    ArrayAdapter<String> adapter;

    public static final String EXTRA_ACCOUNT = "br.pcfl.up.ChooseIdentity_account";
    public static final String EXTRA_IDENTITY = "br.pcfl.up.ChooseIdentity_identity";
