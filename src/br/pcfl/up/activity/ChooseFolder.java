...
public class ChooseFolder extends UpListActivity {
    public static final String EXTRA_ACCOUNT = "br.pcfl.up.ChooseFolder_account";
    public static final String EXTRA_CUR_FOLDER = "br.pcfl.up.ChooseFolder_curfolder";
    public static final String EXTRA_SEL_FOLDER = "br.pcfl.up.ChooseFolder_selfolder";
    public static final String EXTRA_NEW_FOLDER = "br.pcfl.up.ChooseFolder_newfolder";
    public static final String EXTRA_MESSAGE = "br.pcfl.up.ChooseFolder_message";
    public static final String EXTRA_SHOW_CURRENT = "br.pcfl.up.ChooseFolder_showcurrent";
    public static final String EXTRA_SHOW_FOLDER_NONE = "br.pcfl.up.ChooseFolder_showOptionNone";
    public static final String EXTRA_SHOW_DISPLAYABLE_ONLY = "br.pcfl.up.ChooseFolder_showDisplayableOnly";
        ...
        public void listFolders(Account account, Folder[] folders) {
            ...
            for (Folder folder : folders) {
                ...
                try {
                    ...
                    Log.e(Up.LOG_TAG, "Couldn't get prefs to check for displayability of folder " +
                            folder.getName(), me);
                }
            ...
            if (mShowOptionNone) {
                localFolders.add(Up.FOLDER_NONE);
            }
            ...
            try {
                ...
                for (String name : localFolders) {
                    if (mAccount.getInboxFolderName().equalsIgnoreCase(name)) {
                        ...
                        mHeldInbox = name;
                    } else if (!Up.ERROR_FOLDER_NAME.equals(name) &&
