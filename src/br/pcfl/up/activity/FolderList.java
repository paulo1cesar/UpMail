...
public class FolderList extends UpListActivity {
    ...
    * queueing up a remote update of the folder.
    ...
    private void checkMail(FolderInfoHolder folder) {
        ...
        wakeLock.acquire(Up.WAKE_LOCK_TIMEOUT);
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (intent.getBooleanExtra(EXTRA_FROM_SHORTCUT, false) &&
                   !Up.FOLDER_NONE.equals(mAccount.getAutoExpandFolderName())) {
    ...
    * like unread message count and read status are updated.
    ...
    @Override public void onResume() {
        ...
        if (!mAccount.isAvailable(this)) {
            Log.i(Up.LOG_TAG, "account unavaliabale, not showing folder-list but account-list");
    ...
    private void onClearFolder(Account account, String folderName) {
        ...
        try {
            if (account == null || folderName == null || !account.isAvailable(FolderList.this)) {
                Log.i(Up.LOG_TAG, "not clear folder of unavailable account");
                return;
            }
            ...
            Log.e(Up.LOG_TAG, "Exception while clearing folder", e);
        } finally {
            if (localFolder != null) {
                localFolder.close();
            }
    ...
    class FolderListAdapter extends BaseAdapter implements Filterable {
                ...
                if (account.equals(mAccount)) {
                    ...
                    for (Folder folder : folders) {
                        try {
                            ...
                            Log.e(Up.LOG_TAG, "Couldn't get prefs to check for displayability of folder " + folder.getName(), me);
                        }
                ...
                try {
                    if (account != null && folderName != null) {
                        if (!account.isAvailable(FolderList.this)) {
                            Log.i(Up.LOG_TAG, "not refreshing folder of unavailable account");
                            return;
                        }
                        localFolder = account.getLocalStore().getFolder(folderName);
                    ...
                    Log.e(Up.LOG_TAG, "Exception while populating folder", e);
                } finally {
                    if (localFolder != null) {
                        localFolder.close();
                    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (position <= getCount()) {
                ...
                Log.e(Up.LOG_TAG, "getView with illegal positon=" + position
        ...
        public View getItemView(int itemPosition, View convertView, ViewGroup parent) {
            ...
            if(folder.unreadMessageCount == -1) {
               folder.unreadMessageCount = 0;
                try {
                    ...
                    Log.e(Up.LOG_TAG, "Unable to get unreadMessageCount for " + mAccount.getDescription() + ":"
                          + folder.name);
                }
            }
            ...
            if (folder.flaggedMessageCount == -1) {
                ...
                try {
                    ...
                    Log.e(Up.LOG_TAG, "Unable to get flaggedMessageCount for " + mAccount.getDescription() + ":"
                          + folder.name);
                }

                    }

            if (Up.messageListStars() && folder.flaggedMessageCount > 0) {
