...
public class UpPreferenceActivity extends SherlockPreferenceActivity {
    @Override
    public void onCreate(Bundle icicle) {
        UpActivityCommon.setLanguage(this, Up.getUpLanguage());
        ...
        if (Build.VERSION.SDK_INT >= 6 && Build.VERSION.SDK_INT < 14) {
            ...
            setTheme(Up.getUpThemeResourceId(Up.Theme.DARK));
        } else {
            setTheme(Up.getUpThemeResourceId());
        }
