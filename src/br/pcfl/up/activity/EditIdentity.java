...
public class EditIdentity extends UpActivity {

    public static final String EXTRA_IDENTITY = "br.pcfl.up.EditIdentity_identity";
    public static final String EXTRA_IDENTITY_INDEX = "br.pcfl.up.EditIdentity_identity_index";
    public static final String EXTRA_ACCOUNT = "br.pcfl.up.EditIdentity_account";
