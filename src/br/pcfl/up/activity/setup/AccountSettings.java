...
public class AccountSettings extends UpPreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLocalStorageProvider = (ListPreference) findPreference(PREFERENCE_LOCAL_STORAGE_PROVIDER);
        {
            ...
            providers = StorageManager.getInstance(Up.app).getAvailableProviders();
            int i = 0;
    ...
    private class PopulateFolderPrefsTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            allFolderValues[0] = Up.FOLDER_NONE;
            allFolderLabels[0] = Up.FOLDER_NONE;
