...
import br.pcfl.up.mail.filter.Hex;
 ...
 */
public class AccountSetupCheckSettings extends UpActivity implements OnClickListener {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.e(Up.LOG_TAG, "Error while testing settings", afe);
                    showErrorDialog(
                        R.string.account_setup_failed_dlg_auth_message_fmt,
                        afe.getMessage() == null ? "" : afe.getMessage());
                } catch (final CertificateValidationException cve) {
                    Log.e(Up.LOG_TAG, "Error while testing settings", cve);
                    ...
                    Log.e(Up.LOG_TAG, "Error while testing settings", t);
                    showErrorDialog(
                        R.string.account_setup_failed_dlg_server_message_fmt,
        ...
        mHandler.post(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    Log.e(Up.LOG_TAG, "Error while initializing MessageDigest", e);
                }
                ...
                for (int i = 0; i < chain.length; i++) {
                    ...
                    try {
                        ...
                        if (subjectAlternativeNames != null) {
                            ...
                            for (List<?> subjectAlternativeName : subjectAlternativeNames) {
                                ...
                                case 0:
                                    Log.w(Up.LOG_TAG, "SubjectAltName of type OtherName not supported.");
                                    continue;
                                case 1: // RFC822Name
                                    name = (String)value;
                                    break;
                                case 2:  // DNSName
                                    ...
                                    break;
                                case 3:
                                    Log.w(Up.LOG_TAG, "unsupported SubjectAltName of type x400Address");
                                    continue;
                                case 4:
                                    Log.w(Up.LOG_TAG, "unsupported SubjectAltName of type directoryName");
                                    continue;
                                case 5:
                                    Log.w(Up.LOG_TAG, "unsupported SubjectAltName of type ediPartyName");
                                    continue;
                                case 6:  // Uri
                                    name = (String)value;
                                    break;
                                case 7: // ip-address
                                    ...
                                    break;
                                default:
                                    Log.w(Up.LOG_TAG, "unsupported SubjectAltName of unknown type");
                                    continue;
                                }
                        ...
                        Log.w(Up.LOG_TAG, "cannot display SubjectAltNames in dialog", e1);
                    }
                    ...
                    if (sha1 != null) {
                        ...
                        try {
                            ...
                            Log.e(Up.LOG_TAG, "Error while encoding certificate", e);
                        }
                    }
                }
