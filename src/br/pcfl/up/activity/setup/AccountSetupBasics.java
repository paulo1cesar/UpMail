 ...
 */
public class AccountSetupBasics extends UpActivity
    ...
    private String getOwnerName() {
        ...
        try {
            ...
            Log.e(Up.LOG_TAG, "Could not get default account name", e);
        }
    ...
    private Provider findProviderForDomain(String domain) {
        try {
            ...
            Log.e(Up.LOG_TAG, "Error while trying to load provider settings.", e);
        }
        return null;
    }
