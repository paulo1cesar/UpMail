...
import br.pcfl.up.mail.store.ImapStore.ImapStoreSettings;
import br.pcfl.up.mail.store.WebDavStore.WebDavStoreSettings;
...
public class AccountSetupIncoming extends UpActivity implements OnClickListener {
    ...
    private String getDefaultPort(ConnectionSecurity securityType) {
        ...
        case SSL_TLS_REQUIRED:
            ...
            break;
        default:
            Log.e(Up.LOG_TAG, "Unhandled ConnectionSecurity type encountered");
            port = "";
        }
        return port;
    }
        ...
        if (resultCode == RESULT_OK) {
            if (Intent.ACTION_EDIT.equals(getIntent().getAction())) {
                ...
                try {
                    ...
                    Log.e(Up.LOG_TAG, "Couldn't urlencode username or password.", enc);
