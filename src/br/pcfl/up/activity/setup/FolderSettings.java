...
public class FolderSettings extends UpPreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e(Up.LOG_TAG, "Unable to edit folder " + folderName + " preferences", me);
            return;
        }
    ...
    public void onPause() {
        try {
            ...
            Log.e(Up.LOG_TAG, "Saving folder settings failed", e);
        }
