    ...
    public MessageReference(final String identity) throws MessagingException {
        ...
        if (identity.charAt(0) == IDENTITY_VERSION_1.charAt(0)) {
            ...
            if (tokens.countTokens() >= 3) {
                ...
                if (Up.DEBUG)
                    Log.d(Up.LOG_TAG, "Thawed " + toString());
            } else {
            ...
            if (account != null) {
                ...
                if (folder != null) {
                    ...
                    if (message != null) {
                        ...
                        Log.d(Up.LOG_TAG, "Could not restore message, uid " + uid + " is unknown.");
                    }
                } else {
                    Log.d(Up.LOG_TAG, "Could not restore message, folder " + folderName + " is unknown.");
                }
            } else {
                Log.d(Up.LOG_TAG, "Could not restore message, account " + accountUuid + " is unknown.");
            }
        } catch (MessagingException e) {
            Log.w(Up.LOG_TAG, "Could not retrieve message for reference.", e);
        }
