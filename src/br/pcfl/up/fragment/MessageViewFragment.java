...
import br.pcfl.up.crypto.CryptoProvider.CryptoDecryptCallback;
...
import br.pcfl.up.view.AttachmentView;
import br.pcfl.up.view.MessageHeader;
import br.pcfl.up.view.SingleMessageView;
import br.pcfl.up.view.AttachmentView.AttachmentFileDownloadCallback;
...
public class MessageViewFragment extends SherlockFragment implements OnClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Context context = new ContextThemeWrapper(inflater.getContext(),
                Up.getUpThemeResourceId(Up.getUpMessageViewTheme()));
    ...
    private void displayMessage(MessageReference ref, boolean resetPgpData) {
        ...
        if (Up.DEBUG) {
            Log.d(Up.LOG_TAG, "MessageView displaying message " + mMessageReference);
        }
    ...
    public void onDelete() {
        if (Up.confirmDelete() || (Up.confirmDeleteStarred() && mMessage.isSet(Flag.FLAGGED))) {
    ...
    public void onRefile(String dstFolder) {
        ...
        if (Up.FOLDER_NONE.equalsIgnoreCase(dstFolder)) {
            return;
        }

        if (mAccount.getSpamFolderName().equals(dstFolder) && Up.confirmSpam()) {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Log.v(Up.LOG_TAG, "loadMessageForViewBodyAvailable", e);
                    }
                }
            });
        }
    ...
    public void onDecryptDone(PgpData pgpData) {
        ...
        try {
            ...
            Log.e(Up.LOG_TAG, "displayMessageBody failed", e);
        }
    }
