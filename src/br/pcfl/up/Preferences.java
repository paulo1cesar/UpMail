...
import br.pcfl.up.preferences.Editor;
import br.pcfl.up.preferences.Storage;
...
public class Preferences {
    ...
    private Preferences(Context context) {
        ...
        mContext = context;
        if (mStorage.size() == 0) {
            Log.i(Up.LOG_TAG, "Preferences storage is zero-size, importing from Android-style preferences");
