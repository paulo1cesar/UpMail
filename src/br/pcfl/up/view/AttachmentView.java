...
import br.pcfl.up.helper.MediaScannerNotifier;
...
import br.pcfl.up.mail.store.LocalStore.LocalAttachmentBodyPart;
...
public class AttachmentView extends FrameLayout implements OnClickListener, OnLongClickListener {
    ...
    public boolean populateFromPart(Part inputPart, Message message, Account account,
        ...
        if ((!MimeUtility.mimeTypeMatches(contentType, Up.ACCEPTABLE_ATTACHMENT_VIEW_TYPES))
                || (MimeUtility.mimeTypeMatches(contentType, Up.UNACCEPTABLE_ATTACHMENT_VIEW_TYPES))) {
            viewButton.setVisibility(View.GONE);
        }
        if ((!MimeUtility.mimeTypeMatches(contentType, Up.ACCEPTABLE_ATTACHMENT_DOWNLOAD_TYPES))
                || (MimeUtility.mimeTypeMatches(contentType, Up.UNACCEPTABLE_ATTACHMENT_DOWNLOAD_TYPES))) {
            downloadButton.setVisibility(View.GONE);
        }
        if (size > Up.MAX_ATTACHMENT_DOWNLOAD_SIZE) {
            viewButton.setVisibility(View.GONE);
            downloadButton.setVisibility(View.GONE);
        }
    ...
    public void writeFile(File directory) {
        try {
            ...
            if (Up.DEBUG) {
                Log.e(Up.LOG_TAG, "Error saving attachment", ioe);
            }
            attachmentNotSaved();
        }
    }
    ...
    public void writeFile() {
        writeFile(new File(Up.getAttachmentDefaultPath()));
    }
    ...
    public void showFile() {
        ...
        try {
            ...
            Log.e(Up.LOG_TAG, "Could not display attachment of type " + contentType, e);
    ...
    public void checkViewable() {
        ...
        try {
            ...
            Log.e(Up.LOG_TAG, "Cannot resolve activity to determine if we shall show the 'view'-button for an attachment", e);
        }
    }
