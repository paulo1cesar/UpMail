...
import br.pcfl.up.helper.ClipboardManager;
...
import br.pcfl.up.provider.AttachmentProvider.AttachmentProviderColumns;
...
public class SingleMessageView extends LinearLayout implements OnClickListener,
    ...
    public void setHeaders(final Message message, Account account) {
        try {
            ...
            Log.e(Up.LOG_TAG, "setHeaders - error", me);
        }
    }
    ...
    public void renderAttachments(Part part, int depth, Message message, Account account,
        ...
        if (part.getBody() instanceof Multipart) {
            ...
            try {
                ...
                Log.e(Up.LOG_TAG, "Error adding attachment view", e);
            }
        }
    }
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    File directory = new File(Up.getAttachmentDefaultPath());
