...
public class MessageWebView extends RigidWebView {
    ...
    public void configure() {
        ...
        if (isSingleColumnLayoutSupported() && Up.mobileOptimizedLayout()) {
        ...
        webSettings.setTextZoom(Up.getFontSizes().getMessageViewContentAsPercent());
    ...
    public void emulateShiftHeld() {
        try {
            ...
            Log.e(Up.LOG_TAG, "Exception in emulateShiftHeld()", e);
        }
    }
